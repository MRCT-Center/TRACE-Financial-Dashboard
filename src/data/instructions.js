...
export const EXPENSES_REGULAR = [
  'Step 1: Select your country from the drop-down list in each "Country" cell below.',
  'Step 2: Select the unit that you are planning/budgeting for from the drop down list in the cells for "Unit."',
  'Step 3: Review the regular expense categories listed below. These have been pre-populated by the MRCT Center, based on review of country budget structures and discussion with country staff.',
  'Step 4: Review the regular expense items listed below. These have been pre-populated by the MRCT Center, based on review of country budget structures and discussion with country staff. Please review this list in tandem with the item descriptions in the item description column. If you believe the item listed should be broken into multiple items on different rows, please make that change and note that in the notes/comments column.',
  'Step 5a: Enter the expense in local currency if your country primarily uses local currency in its budget reports. If your country reports expenses in both local currency and USD or charges expenses only in USD, please enter the expense in local currency and then the current exchange rate and the expense listed in local currency column will convert to USD. Note: If you are reporting expenses only in USD, leave the zeros in the local currency column and type over the zeros/formula in the Amount (USD) with the expense amount in USD. Please note, IF you will be documenting in-kind contributions that are "off-budget," you will list the portion of the full regular expense that is "donated" on the in-kind contribution_regular worksheet.',
  'Step 5b: Select from the drop-down list in each cell for "Expense currency" the currency in which the regular expense is listed in the country budget.',
  'Step 5c: Review the exchange rate for the currency that your country primarily budgets in. Use the the drop-down list in each cell to correct any errors.',
  'Step 5d: Enter the expense in USD if your country primarily uses USD in its budget reports. Note about in-kind: an in-kind contribution is where an entity (the federal government, an institution such as a University, or another source) "gives" the Secretariat/NEC/IRB personnel time, an office, office supplies, or other items that they do not have to pay for from their regular or irregular budget. For example, if the government gives the Secretariat office space valued at $20,000/year, list $0 on expenses_regular in the row for rent AND show $20,000 in the in-kind contributions_regular sheet for rent.',
  'Step 6: Review the regular expense item descriptions listed below. These have been pre-populated by the MRCT Center, based on review of country budget structures and discussion with country staff. Please review this list in tandem with the items in the item column. If you believe the item description should be more detailed or changes, please say how so in the notes/comments column.',
  'Step 7: List the data source (i.e., document name and date, weblink and specific place on the webpage) for the expense item expense estimate.',
  'Step 8: PLEASE add any comments that will be helpful to others looking at this worksheet. IF you will be documenting in-kind contributions, it is especially important to document the distinction between what is captured on this expenses_regular worksheet and what is captured on the in-kind contributions_regular worksheet. It is also especially important to describe any calculations you do to put a value (in local currency and USD) for each item.',
];
